            ...
            try {
                featureEntities.add(
                    DailyFeaturesEntity(
                        ...
                        dailyStepCount = doc.getDouble("dailyStepCount")?.toFloat() ?: 0f,
                        activeMinutes = doc.getDouble("activeMinutes")?.toFloat() ?: 0f,
                        keystrokeSpeed = doc.getDouble("keystrokeSpeed")?.toFloat() ?: 0f,
                        backspaceRatio = doc.getDouble("backspaceRatio")?.toFloat() ?: 0f,
                        scrollVelocity = doc.getDouble("scrollVelocity")?.toFloat() ?: 0f,
                        daylightExposureMinutes = doc.getDouble("daylightExposureMinutes")?.toFloat() ?: 0f,
                        chargeRegularity = doc.getDouble("chargeRegularity")?.toFloat() ?: 0f,
