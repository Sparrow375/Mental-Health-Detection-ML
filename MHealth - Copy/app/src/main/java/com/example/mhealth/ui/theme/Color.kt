...
// ── Cove / MHealth Rebranded Palette ─────────────────────────────────────────
val DeepBlue           = Color(0xFF003754)  // Darker navy for text/headers
val MhealthIndigo      = Color(0xFF4F46E5)  // Vibrant indigo for primary metrics
val MhealthTeal        = Color(0xFF0D9488)  // Solid teal for secondary metrics
val MhealthAccentPurple = Color(0xFF7C3AED)  // Vibrant purple for category charts
val MhealthChartCoral  = Color(0xFFF43F5E)  // Warm coral for displacement
val MhealthChartIndigo = Color(0xFF6366F1)  // Classic indigo for trends
val MhealthChartSlate  = Color(0xFF475569)  // Slate gray for baseline
val MhealthChartOrange = Color(0xFFEA580C)  // Rich orange for system metrics
val MhealthTheme       = MhealthIndigo      // Alias for primary theme color
