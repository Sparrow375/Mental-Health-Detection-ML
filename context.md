...
*   **2026-08-09 (Sprint 4: Final UI Polish Fixes)**:
    1. **Settings White Background Fix (`MainActivity.kt`)**: Changed light color scheme `surface` from pure `Color.White` to `Color(0xFFEDF2F0)` (soft green-gray tint), eliminating the harsh white card backgrounds visible when the app is in light/system theme mode. Dark mode already used `NavySurface` and was unaffected.
    ...
    7. **Build Status**: `./gradlew assembleRelease` succeeded (**BUILD SUCCESSFUL in 3m 26s**).
