...
class ExplainabilityEngine:
    ...
    def generate_radar_chart(
        ...
        ax.set_yticklabels([])  # Remove radial tick labels (point labels)
        ax.set_xticks(angles[:-1])
        ax.set_xticklabels([])  # Remove all feature text labels from the edges
