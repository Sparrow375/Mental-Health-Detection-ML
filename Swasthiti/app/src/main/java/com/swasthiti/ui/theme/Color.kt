...
// ── Backgrounds / Surfaces (Swasthiti light theme) ───────────────────────────────
...
// ── Swasthiti / Swasthiti Rebranded Palette ─────────────────────────────────────────
val DeepBlue           = Color(0xFF003754)  // Darker navy for text/headers
val SwasthitiIndigo      = Color(0xFF4F46E5)  // Vibrant indigo for primary metrics
val SwasthitiTeal        = Color(0xFF0D9488)  // Solid teal for secondary metrics
val SwasthitiAccentPurple = Color(0xFF7C3AED)  // Vibrant purple for category charts
val SwasthitiChartCoral  = Color(0xFFF43F5E)  // Warm coral for displacement
val SwasthitiChartIndigo = Color(0xFF6366F1)  // Classic indigo for trends
val SwasthitiChartSlate  = Color(0xFF475569)  // Slate gray for baseline
val SwasthitiChartOrange = Color(0xFFEA580C)  // Rich orange for system metrics
val SwasthitiTheme       = SwasthitiIndigo      // Alias for primary theme color
