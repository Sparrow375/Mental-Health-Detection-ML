...
*   **2026-07-12 (Sprint: Pilot Readiness Adjustments)**:
    ...
    5. **Manual Location Entry Options (T64)**: Added manual text input fields for Latitude and Longitude coordinates to both the `SettingsScreen` and Onboarding wizard Step 6 Home Location cards, allowing users to define their home anchor from anywhere.
