...
/**
 * SwasthitiDatabase — Room database singleton.
 ...
 *
 * Access via SwasthitiDatabase.getInstance(context)
 */
@Database(
    entities = [
...
abstract class SwasthitiDatabase : RoomDatabase() {
    ...
    companion object {
        @Volatile private var INSTANCE: SwasthitiDatabase? = null
        ...
        fun getInstance(context: Context): SwasthitiDatabase =
            INSTANCE ?: synchronized(this) {
                INSTANCE ?: Room.databaseBuilder(
                    context.applicationContext,
                    SwasthitiDatabase::class.java,
                    "Swasthiti_database"
                )
                    .addMigrations(
