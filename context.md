...
*   **2026-07-13 (Sprint: Debug Map Picker)**:
    ...
    3. **Debounced Search Autocomplete Suggestions**: Embedded a dynamic typeahead autocomplete dropdown below the map search input utilizing the Nominatim Search API. Employs a 400ms input debouncer to restrict API query rates and prevent server-side spam/blocks. Clicking suggestions updates input, map view frame, and the interactive marker location automatically.
